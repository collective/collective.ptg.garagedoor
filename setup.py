...
setup(name='collective.ptg.garagedoor',
      version=version,
      description="Garagedoor integration as a Gallery Display Type extension for PloneTrueGallery package",
      ...
      keywords='web zope plone cms plonetruegallery gallery addon garagedoor',
